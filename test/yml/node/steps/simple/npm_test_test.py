...
contents = parse_node_simple_step_template_yaml_file("npm-run-test.yml")
...
def test_task_test_npm_script_name_parameter_default():
    assert parameters["testNpmScriptName"] == "test"
...
def test_step_custom_command_input():
    ...
    assert value == "run ${{ parameters.testNpmScriptName }}"
