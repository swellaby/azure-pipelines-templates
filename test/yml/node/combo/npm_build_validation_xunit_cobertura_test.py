...
runNpmScriptParamaters = parameters["runNpmBuildScript"]
...
def test_run_npm_build_script_step_script_name_name_parameter_default():
    assert runNpmScriptParamaters["buildNpmScriptName"] == "build"


def test_run_npm_build_script_step_display_name_parameter_default():
    assert runNpmScriptParamaters["taskDisplayName"] == "Run build script"
